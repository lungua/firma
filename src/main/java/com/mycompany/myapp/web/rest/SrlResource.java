...
public class SrlResource {
     ...
     */
    @PostMapping("/srls")
    public ResponseEntity<Srl> createSrl(@Valid @RequestBody Srl srl) throws URISyntaxException {
     ...
     */
    @PutMapping("/srls/{id}")
    public ResponseEntity<Srl> updateSrl(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Srl srl)
    ...
    public ResponseEntity<Srl> partialUpdateSrl(@PathVariable(value = "id", required = false) final Long id, @NotNull @RequestBody Srl srl)
        throws URISyntaxException {
        ...
        Optional<Srl> result = srlRepository
            ...
            .map(existingSrl -> {
                ...
                if (srl.getTelefon() != null) {
                    existingSrl.setTelefon(srl.getTelefon());
                }
                if (srl.getEmail() != null) {
                    existingSrl.setEmail(srl.getEmail());
                }
                if (srl.getSrlFinalizat() != null) {
                    existingSrl.setSrlFinalizat(srl.getSrlFinalizat());
                }
                if (srl.getLogatCu() != null) {
                    existingSrl.setLogatCu(srl.getLogatCu());
                }
    ...
    public ResponseEntity<Srl> getSrl(@PathVariable Long id) {
        ...
        Optional<Srl> srl = srlRepository.findById(id);
