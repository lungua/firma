...
type SrlFormDefaults = Pick<NewSrl, 'id' | 'nuneFinal' | 'dataInregistrare'>;
...
type SrlFormGroupContent = {
  ...
  inregistratDe: FormControl<SrlFormRawValue['inregistratDe']>;
};
...
export class SrlFormService {
  createSrlFormGroup(srl: SrlFormGroupInput = { id: null }): SrlFormGroup {
    ...
    return new FormGroup<SrlFormGroupContent>({
      ...
      inregistratDe: new FormControl(srlRawValue.inregistratDe),
    });
  }
